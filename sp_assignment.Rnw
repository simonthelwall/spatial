...
\section{Part 1}
\subsection{A}
Table \ref{tab1} shows the distribution of the prevalence of stunted growth and of wasting in children attending schools in the south east Kenyan coastal region.
...
\begin{figure}[b]
\includegraphics[width = \textwidth]{point_maps.png.png}
\caption{Geospatial distribution of the prevalence of stunting and underweightness in school children attending school in Coastal Kenya.}
\label{dist_maps}
\end{figure}
...
For underweightness, spatial relationships have no effect after about 25 decimal degrees. 
